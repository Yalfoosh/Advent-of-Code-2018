...
pub const SOME_NUMBER_IS_INVALID_MESSAGE: &str = "Some number in input is invalid!";
pub const CANT_ARE_IDENTICAL_MESSAGE: &str = "Function are_identical() failed to find char at index.";
pub const CANT_FIX_FIRST_DIFFERENCE_MESSAGE: &str = "Function fix_first_difference() failed to find char at index.";
